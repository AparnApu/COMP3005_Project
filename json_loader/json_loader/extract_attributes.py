...
###############################################################################################
# Get all attributes for a type of file (but matches now)
###############################################################################################

def extract_attributes_for_matches():
...
# Call helper here
extract_attributes_for_matches()